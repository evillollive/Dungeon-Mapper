...
export function buildKeyBindings(actions: ShortcutActions): KeyBinding[] {
  ...
  return [
    ...
    },
    {
      ...
      category: 'View',
      keys: 'Shift+V',
      description: 'Toggle GM ↔ Player view',
    ...
    },
    {
      ...
      category: 'View',
      keys: 'T',
      description: 'Cycle to next theme (GM only)',
    ...
    },
    {
      ...
      category: 'View',
      keys: 'Shift+T',
      description: 'Cycle to previous theme (GM only)',
      match: e => isPlainKey(e) && e.shiftKey && e.key.toLowerCase() === 't',
      action: () => { if (actions.isGmView()) actions.cycleTheme(-1); },
    },
    {
      ...
      category: 'View',
      keys: ']',
      description: 'Cycle to next tile in palette (GM only)',
    ...
    },
    {
      ...
      category: 'View',
      keys: '[',
      description: 'Cycle to previous tile in palette (GM only)',
      match: e => isPlainKey(e) && e.key === '[',
      action: () => { if (actions.isGmView()) actions.cycleActiveTile(-1); },
    },
    {
