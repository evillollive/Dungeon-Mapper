...
export type ThemeRoomPalette = RoomKind[];

const CASTLE: ThemeRoomPalette = [
...
const STARSHIP: ThemeRoomPalette = [
...
const OLDWEST: ThemeRoomPalette = [
...
const STEAMPUNK: ThemeRoomPalette = [
...
const CYBERPUNK: ThemeRoomPalette = [
...
const MODERNCITY: ThemeRoomPalette = [
...
const DUNGEON: ThemeRoomPalette = [
...
export function getRoomPalette(themeId?: string): ThemeRoomPalette | undefined {
  if (!themeId) return undefined;
  return THEME_ROOM_PALETTES[themeId];
}

/** True when the theme defines a room palette and per-room labels are useful. */
export function themeSupportsRoomLabels(themeId?: string): boolean {
