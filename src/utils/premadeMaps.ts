    ...
    levels: [
      {
        ...
        labelRooms: true,
        nameRooms: true,
        noteFlavor: 'The main deck of the Black Harpy, with helm, captain\'s cabin, and crew quarters.',
      ...
      },
      {
        ...
        labelRooms: true,
        nameRooms: true,
        noteFlavor: 'Below decks — galley, brig, crew berths, and the powder magazine.',
        tokenTheme: encounter(['Cook Grease', 'cleric'], ['Bilge Rat', 'dagger'], ['Press-Ganged Sailor', 'sword'], ['First Mate Keel', 'axe']),
        lightColor: WILD_LIGHT,
      },
      {
        name: 'Cargo Hold',
        ...
        labelRooms: true,
        nameRooms: true,
        noteFlavor: 'The deepest hold — plundered treasure, smuggled contraband, and bilge water.',
        tokenTheme: encounter(['Stowaway Wren', 'rogue'], ['Guard Dog', 'fireball'], ['Cargo Spider', 'spider'], ['Cursed Figurehead', 'skull']),
        lightColor: WILD_LIGHT,
      },
    ],
  },
...
export const PREMADE_MAP_SUMMARIES: PremadeMapSummary[] = [...PREMADE_MAP_SPECS.map(spec => ({
  ...
  id: FOLIO_TOKEN_REFERENCE_ID,
  name: FOLIO_TOKEN_REFERENCE_NAME,
  themeId: FOLIO_THEME_ID,
  themeLabel: 'Dungeon Folio v1',
