...
export default defineConfig({
  testDir: './src/test',
  testMatch: ['ux09.spec.mjs', 'ux09Performance.spec.mjs', 'ux09EdgeBlend.spec.mjs', 'ux09FolioTiles.spec.mjs', 'ux07Furnishings.spec.mjs', 'ux07Tokens.spec.mjs', 'interfaceIcons.spec.mjs'],
