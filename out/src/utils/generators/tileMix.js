 ...
 * range.
 */
export function getRoomsTileMixSliders(themeId) {
 ...
 */
export const ROOMS_TILE_MIX_SLIDERS = getRoomsTileMixSliders();
/**
 ...
 */
export function getRoomsDefaultMix(themeId) {
...
/* ── Open Terrain ─────────────────────────────────────────────── */
export const OPEN_TERRAIN_TILE_MIX_SLIDERS = [
    {
        key: 'wall',
        label: 'Obstacles',
        min: 0,
 ...
 */
export function getOpenTerrainDefaultMix(themeId) {
...
/* ── Cavern ───────────────────────────────────────────────────── */
export const CAVERN_TILE_MIX_SLIDERS = [
    {
        key: 'wall',
        label: 'Wall fill',
        min: 0.3,
 ...
 * cavern" look.
 */
export function getCavernDefaultMix() {
    return {
        wall: 0.45,
...
export const GENERATOR_TILE_MIX = {
 ...
 */
export function getTileMixSliders(generatorId, themeId) {
    switch (generatorId) {
...
export function getDefaultTileMix(generatorId, themeId) {
    switch (generatorId) {
        case 'rooms-and-corridors':
